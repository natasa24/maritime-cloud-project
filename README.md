...
| **Thingsboard** | **IoT Platform:** Υποδέχεται τα δεδομένα, τα οπτικοποιεί σε Dashboard και εκτελεί τους κανόνες ελέγχου (Rule Chains). |
...
| **Minio** | **Object Storage:** Αποθηκεύει μόνιμα τα αρχεία καταγραφής (Logs) σε μορφή JSON. |
...
* **Protocols:** MQTT (Device to Cloud), AMQP (Internal Messaging)
